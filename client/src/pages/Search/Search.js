                                                ...
                                                <div id='button' className="col-md-6">
                                                        <SaveButton
                                                            onClick={() => handleBookSave({
                                                                id: result.id, title: result.volumeInfo.title, author: result.volumeInfo.authors[0], description: result.volumeInfo.description, link: result.volumeInfo.previewLink, image: result.volumeInfo.imageLinks.thumbnail},toast.notify(
                                                                    <div style={{ fontSize: '17px',color: 'green', fontFamily: 'Noto Sans JP, sans-serif'}}>Nicely done... you saved a book!
                                                                        </div>
                                                                , {
                                                                    duration: 2500
                                                                  }))}
